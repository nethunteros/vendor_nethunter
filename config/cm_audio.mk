...
ALARM_PATH := vendor/nethunter/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/nethunter/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/nethunter/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/nethunter/prebuilt/common/media/audio/ui
